    ...
    >
      <div className="max-w-3xl mt-28 mx-auto">
        ...
        <motion.div
          ...
          className="bg-[#fff5eb] border border-[#d4a373] rounded-lg p-4 mb-8"
        >
        ...
        <div className="space-y-8">
          <motion.div variants={fadeIn("up", 0.5)}>
            ...
            <p className="text-gray-700">
              At Loffia, we respect your privacy and are committed to protecting
          ...
          <motion.div variants={fadeIn("up", 0.6)}>
            ...
            <div className="space-y-4">
              <div>
                <span className="text-[#b47d56] font-medium">
                  Personal Information:
                </span>
                <span className="text-gray-700">
                  Includes name, email, phone number, address, and payment
                  details.
                </span>
              </div>
              <div>
                ...
                <span className="text-gray-700">
                  Such as browser type, IP address, and pages visited on our
                  website.
                </span>
              </div>
            </div>
