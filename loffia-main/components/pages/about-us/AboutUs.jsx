      ...
      <section className="py-16 flex flex-col gap-3 w-[95%] sm:w-[85%] mx-auto">
        ...
        >
          <motion.p variants={fadeIn("up", 0.2, 1)}>
            At Loffia, we are dedicated to transforming health through
            innovative, sustainable nutritional supplements.
          </motion.p>
          Our mission goes beyond simply creating supplements. We are committed
          to providing holistic wellness solutions that address the complex
          nutritional needs of modern life. By combining cutting-edge
          nutritional science with sustainable, natural ingredients, we create
          supplements that support your body&apos;s optimal functioning. We
          understand that true wellness is a journey, not a destination.
          That&apos;s why our approach is comprehensive – focusing not just on
          individual supplements, but on supporting your overall health, energy,
          and vitality. Each product is carefully formulated to meet the highest
          standards of quality, efficacy, and environmental responsibility.
        </motion.div>
      </section>
        ...
        >
          ...
          >
            <div className="w-fit flex flex-col items-center justify-center">
              ...
              <p className="text-[#d4a017] text-nowrap text-center font-semibold">
                Dr. Emily Chen
              </p>
            ...
            >
              With over 15 years of experience in nutrition and holistic
              wellness, I founded Loffia to provide scientifically-backed,
              natural supplements that support optimal health and well-being.
            </motion.p>
          </motion.div>
          ...
          >
            <div className="w-fit flex flex-col items-center justify-center">
              ...
              <p className="text-[#d4a017] text-center text-nowrap font-semibold">
                Michael Rodriguez
              </p>
              <p className="text-[#777] text-nowrap text-center">
                Research Director
              </p>
            </div>
            <motion.p
              ...
              className="text-[#777] w-[65%]"
            >
              Our rigorous research process ensures that every Loffia supplement
              is developed using the highest quality, sustainably sourced
              ingredients and cutting-edge nutritional science.
            </motion.p>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section className="py-16 flex flex-col gap-3 w-[95%] sm:w-[85%] mx-auto">
        ...
        >
          ...
          <OurTeamCard
            src=""
            name="Sarah Thompson"
            title="Wallness Strategy Director"
          />
          <OurTeamCard src="" name="David Kim" title="Quality Assurance lead" />
          <OurTeamCard
            src=""
            name="Lisa Chen"
            title="Nutrition Science Specialist"
          />
        </motion.div>
      </section>
    </motion.div>
